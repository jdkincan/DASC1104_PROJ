...
Speaking of, shot distance was an interesting challenge that I faced. 
...
plot6 
```
That is "Sprawlball". This shooting distribution is essential to the strategy. At a basic level it attempts to spread the floor in order to take as many high value shots as possible. Here we see a clearly defined transition over just 9 years, with shots becoming more concentrated around high value areas. Without so much as a picture to help plot the 3pt line, it's there. In the 2019 data, the line appears in stark contrast with the rest of the floor. We are now realizing the full potential of what the line brings to the game. As players get better at shooting longer shots 


These two plots are easily my favorite. The way the transition is so clearly portrayed excites me. Without even a picture to help plot the 3 point line it's there. In the 2019 data, the line appears in stark contrast with the rest of the floor. We are now realizing  
```{r, warning=FALSE}
# shots10_pct 
#NOTES
  #Add Legend 
...
plot9 <- ggplot(ptsperdat, aes(x = shot_zone, y = ptspershot.x, fill = ptspershot.x)) +
  ...
  #scale_y_discrete(name = "Shooting Percentage",
                    ...
                    # limits = c(0, 80)) +
  #scale_fill_binned(low="skyblue1", high="firebrick") +
  #theme(legen![](/2020-12-08-nba-evolution/index_files/nba-basketball-iso.png)d.title = element_blank())
plot9
