...
# Data Weaknesses 
  ...
  An issue I encountered in the data was inconsistent collection of 3-point data. The charts exploring Points Per Shot over Distance From Basket hit the root of this problem. As shown, the distance at which 3s are recorded is inconsistent. I believe this is due to some sort of strange rounding procedure surrounding corner 3-pointers. To fix the issue, the NBA should update the old data, and/or establish consistent data cleaning procedures. 
